...
import { UserGet } from './utils';

function Popup({ ids, name, config, onClose, onUpdate, onDelete, imageChange = false, bannerChange = false, safeDelete = false, user = null }) {
    ...
    const handleInputChange = (key, value) => {
        ...
        setInputs(newInputs);
        setTitleError(false); // Reset title error when the input changes
    };
